...
def main( variants_path:str, schema_yaml:str, base_config_yaml:str, max_variants:int, output_dir:str):
   
    project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    variants_path = os.path.join(project_root, variants_path)
    schema_yaml = os.path.join(project_root, schema_yaml)
    base_config_yaml = os.path.join(project_root, base_config_yaml)
...
if __name__ == "__main__":
    print("main")
    main("./agents/rag/variants.json", "./agents/schemas/agent_config_schema.yaml", "./agents/rag/rag_agent_config.yaml", 50, "./agents/rag/evaluation/configurations/generated")